...
<%@page import="com.simplilearn.model.Teacher"%>
<%@page import="com.simplilearn.model.Subject"%>
<%@page import="com.simplilearn.model.Classes"%>
...
<%
	for(Student student : clasForReport.getStudents()){
		out.print("<tr>");
		out.print("<td>" + student.getFname() + " " + student.getFname() + "</td>");
		out.print("</tr>");
	}
%>
</table>
